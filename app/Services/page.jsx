  ...
  return (
    <main className="bg-gray-900 text-gray-100 px-6 py-20">
      <header className="text-center mb-16">
        <h1 className="text-4xl font-extrabold text-sky-400">Our Services</h1>
      ...
      <section className="grid gap-10 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
        {services.map(({ title, description, icon }) => (
          ...
          >
            <div className="text-4xl text-sky-400 mb-4">{icon}</div>
      ...
      <section className="mt-24 max-w-5xl mx-auto text-center">
        <h2 className="text-3xl font-bold text-sky-300 mb-6">Why Choose SkyLight?</h2>
      ...
      <section className="mt-24 max-w-6xl mx-auto px-6 text-center">
        <h2 className="text-3xl font-bold text-sky-300 mb-12">What Our Clients Say</h2>
        <div className="grid gap-10 md:grid-cols-3">
          {testimonials.map(({ name, role, quote }) => (
            ...
            >
              ...
              <footer className="text-sky-400 font-semibold">{name}</footer>
