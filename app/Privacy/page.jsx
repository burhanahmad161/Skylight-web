...
export default function PrivacyPolicy() {
  return (
    <main className="bg-gray-900 text-gray-200 min-h-screen px-6 py-20">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-cyan-600 to-blue-700/80 p-10 rounded-3xl shadow-xl mb-14 relative overflow-hidden">
        ...
        <div className="space-y-10 text-sm sm:text-base">
          ...
          {[
            ...
            },
            {
              ...
              content: (
                <>
                  ...
                  <span className="text-cyan-400 font-medium">privacy@skylight.com</span>
                </>
              ),
            },
          ].map((section, idx) => (
            <div
              key={idx}
              className="bg-gray-800/50 border border-gray-700 p-6 rounded-2xl hover:shadow-lg transition duration-300"
            >
              <h2 className="text-lg font-semibold text-cyan-300 mb-2">{section.title}</h2>
